...
const PARTNERS = [
  ...
  },
  {
    ...
    desc: "Alex Xiao, founder of Hexa Group, provides direct mentorship to Hexa Hub members navigating cross-border operations, Australian market entry, and business growth. This isn't a referral to a coaching programme — it's access to someone who has built the infrastructure you're standing in.",
    body: "Mentorship at Hexa Hub is particularly valuable for founders entering Australia from Chinese-speaking markets. Alex brings firsthand experience in cross-border e-commerce, property, and the operational challenges of scaling a business across two markets. Sessions are available to members by arrangement.",
    benefits: [
