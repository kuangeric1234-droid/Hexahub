    ...
    <>
      ...
      <main className="pt-16 min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
          <h1 className="text-3xl font-black text-black tracking-tight mb-4">Privacy Policy</h1>
          ...
          <div className="bg-[#F5F5F5] border border-[#E5E5E5] p-8 text-[#555555] text-sm leading-relaxed">
            <p>Privacy policy content to be provided by HexaHub / Hexa Group legal team.</p>
          </div>
        </div>
      </main>
      <Footer />
